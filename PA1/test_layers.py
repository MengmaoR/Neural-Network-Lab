...
plt.legend()
plt.savefig(f'./PA1/img/loss_layers_{args["dataset"]}_{args["model"]}_long.png', dpi = 600)
plt.clf()
...
plt.legend()
plt.savefig(f'./PA1/img/acc_layers_{args["dataset"]}_{args["model"]}_long.png', dpi = 600)